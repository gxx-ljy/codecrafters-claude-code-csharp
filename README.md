[![progress-banner](https://backend.codecrafters.io/progress/claude-code/c31ea2f3-cde8-4d10-951e-21dffeadd374)](https://app.codecrafters.io/users/codecrafters-bot?r=2qF)
...
The entry point for your `claude-code` implementation is in `src/Program.cs`.
